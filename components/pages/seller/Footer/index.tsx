    ...
    <footer className="bg-borderCard-card text-paletteText-primary md:pt-14 md:px-8 p-4 pb-0 flex flex-col items-center">
      ...
      <div className="w-full h-full border-2 md:p-12 p-4 mt-14 space-y-6">
        ...
        <div className="grid md:grid-cols-8 grid-cols-3 items-center space-x-5">
          <div>
            <Image src={bni.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image src={bri.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image src={mandiri.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image src={btn.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image src={qris.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image src={linkAja.src} alt="" className="object-cover mx-auto" />
          </div>
          <div>
            <Image
              src={masterCard.src}
          ...
          <div>
            <Image src={visa.src} alt="" className="object-cover mx-auto" />
          </div>
        </div>
      </div>
      <div>
